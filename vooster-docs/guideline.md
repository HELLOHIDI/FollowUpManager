    ...
    - use the pinned project-local Supabase CLI with Docker only for the approved local development workflow.
    - do not link, push, or reset a remote Supabase project during local development setup.
    - store migration query for `.sql` file. in /supabase/migrations/
    - use Supabase PostgreSQL as the application database and Supabase Storage for uploaded evidence files.
