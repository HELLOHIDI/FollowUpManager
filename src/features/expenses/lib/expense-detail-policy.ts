...
export const expenseStageDetailCopy: Record<ExpenseStageKey, { description: string }> = {
  budget_registration: { description: "단계 진행과 메모를 남깁니다." },
  pre_approval: { description: "단계 진행과 메모를 남깁니다." },
  execution_in_progress: { description: "단계 진행과 메모를 남깁니다." },
  execution_request: { description: "단계 진행과 메모를 남깁니다." },
  execution_completed: { description: "단계 진행과 메모를 남깁니다." },
};
